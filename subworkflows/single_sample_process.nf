...
workflow process_single_sample {
    ...
    main:
        ...
        index_reference_output = index_reference(ref_fasta)
        create_faidx_output = create_faidx(ref_fasta)
        create_ref_dict_output = create_ref_dict(ref_fasta)
        ...
        mutect2_output = mutect2(sample_name,
        ...
        shifted_mutect2_output = shifted_mutect2(sample_name,
...
workflow {
    ...
    main:
        outputs = process_single_sample(params.ref_fasta,
                                        params.sample_name, 
                                        params.fastq_1, 
                                        params.fastq_2, 
